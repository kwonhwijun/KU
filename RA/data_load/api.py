...
category_dict = {"apt" : "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptTradeDev",
...
def make_url(category, lawd_cd, deal_ymd):
    base_url = category_dict[category]
